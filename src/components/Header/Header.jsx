...
export const Header = () => {
  ...
  const takeLogo = () => {
    ...
    if (isTablet) return logoTablet;
    if (isDesktop) return logoDesktop;
    if (isMobile && isRetina) return logoMobileRetina;
    if (isTablet && isRetina) return logoTabletRetina;
    if (isDesktop && isRetina) return logoDesktopRetina;
  };
  ...
  return (
    <>
      <HeaderStyled>
        ...
        ) : (pathname === '/signup' || pathname === '/login') && isDesktop ? null : (
          <BtnList>
            <li>
