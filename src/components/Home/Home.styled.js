...
export const WrapperWtithFruits = styled.div`
  ...
  @media (min-width: 426px) and (max-width: 1023px) {
    ...
    background-image: url(${leavesTablet}), url(${StrawberryTablet}), url(${bananaTablet}),
      url(${VectorTablet});
    background-repeat: no-repeat, no-repeat, no-repeat, no-repeat;
    background-position: bottom 0px left 0px, bottom 200px right 40px, bottom 0px right 0px,
